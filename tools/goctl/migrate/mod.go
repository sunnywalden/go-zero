...
import (
	...
	"github.com/sunnywalden/go-zero/tools/goctl/util/ctx"
)
...
const (
	...
	replacementBuilderx = "github.com/sunnywalden/go-zero/core/stores/builder"
	goZeroMod           = "github.com/sunnywalden/go-zero"
)
