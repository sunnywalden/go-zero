...
import (
	...
	"github.com/sunnywalden/go-zero/tools/goctl/pkg/downloader"
	"github.com/sunnywalden/go-zero/tools/goctl/pkg/goctl"
	"github.com/sunnywalden/go-zero/tools/goctl/rpc/execx"
	"github.com/sunnywalden/go-zero/tools/goctl/util/env"
	"github.com/sunnywalden/go-zero/tools/goctl/util/zipx"
	"github.com/sunnywalden/go-zero/tools/goctl/vars"
)
