...
import (
	...
	"github.com/sunnywalden/go-zero/core/stores/postgres"
	"github.com/sunnywalden/go-zero/core/stores/sqlx"
	"github.com/sunnywalden/go-zero/tools/goctl/config"
	"github.com/sunnywalden/go-zero/tools/goctl/model/sql/command/migrationnotes"
	"github.com/sunnywalden/go-zero/tools/goctl/model/sql/gen"
	"github.com/sunnywalden/go-zero/tools/goctl/model/sql/model"
	"github.com/sunnywalden/go-zero/tools/goctl/model/sql/util"
	file "github.com/sunnywalden/go-zero/tools/goctl/util"
