...
import (
	...
	"github.com/sunnywalden/go-zero/tools/goctl/api"
	"github.com/sunnywalden/go-zero/tools/goctl/bug"
	"github.com/sunnywalden/go-zero/tools/goctl/config"
	"github.com/sunnywalden/go-zero/tools/goctl/docker"
	"github.com/sunnywalden/go-zero/tools/goctl/env"
	"github.com/sunnywalden/go-zero/tools/goctl/gateway"
	"github.com/sunnywalden/go-zero/tools/goctl/internal/cobrax"
	"github.com/sunnywalden/go-zero/tools/goctl/internal/version"
	"github.com/sunnywalden/go-zero/tools/goctl/kube"
	"github.com/sunnywalden/go-zero/tools/goctl/migrate"
	"github.com/sunnywalden/go-zero/tools/goctl/model"
	"github.com/sunnywalden/go-zero/tools/goctl/quickstart"
	"github.com/sunnywalden/go-zero/tools/goctl/rpc"
	"github.com/sunnywalden/go-zero/tools/goctl/tpl"
	"github.com/sunnywalden/go-zero/tools/goctl/upgrade"
