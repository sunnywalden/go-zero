...
import (
	...
	conf "github.com/sunnywalden/go-zero/tools/goctl/config"
	"github.com/sunnywalden/go-zero/tools/goctl/rpc/parser"
...
// see https://github.com/sunnywalden/go-zero/tree/master/tools/goctl/config/config.go
