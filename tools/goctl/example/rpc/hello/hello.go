...
import (
	...
	"github.com/sunnywalden/go-zero/tools/goctl/example/rpc/hello/internal/config"
	greetServer "github.com/sunnywalden/go-zero/tools/goctl/example/rpc/hello/internal/server/greet"
